class Recipe < ApplicationRecord
  ...
  has_many :recipe_nutrient_values, -> { includes(:nutrient).order("nutrients.display_order") },
    dependent: :destroy,
    inverse_of: :recipe
  ...
  validates :serving_count, numericality: { greater_than: 0 }, allow_nil: true
  ...
  def nutrition
    @nutrition ||= Recipe::Nutrition.new(self)
  end
