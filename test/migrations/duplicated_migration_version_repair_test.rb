...
class DuplicatedMigrationVersionRepairTest < ActiveSupport::TestCase
  ...
  test "migration versions have one owner" do
    ...
    [ RUNTIME_VERSION, WORKOUT_VERSION, RECIPE_VERSION, RECONCILIATION_VERSION, MEAL_EVENTS_VERSION, SHOPPING_VERSION ].each do |version|
  ...
  test "fresh and collided histories converge without losing data" do
    canonical_schema = with_isolated_database do |connection, context, pool|
      ...
      assert_equal [ RUNTIME_VERSION, WORKOUT_VERSION, RECIPE_VERSION, RECONCILIATION_VERSION, MEAL_EVENTS_VERSION, SHOPPING_VERSION ],
